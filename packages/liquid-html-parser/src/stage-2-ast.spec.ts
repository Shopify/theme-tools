...
describe('Unit: Stage 2 (AST)', () => {
  ...
  describe('Unit: toLiquidAST(text)', () => {
    ...
    it(`should parse doc tags`, () => {
      ...
      expectPath(ast, 'children.0.body.nodes.0.paramName').to.eql('asdf');
      expectPath(ast, 'children.0.body.nodes.0.paramDescription').to.eql('');
      ...
      expectPath(ast, 'children.0.body.nodes.1.paramName').to.eql('paramWithDescription');
      expectPath(ast, 'children.0.body.nodes.1.paramDescription').to.eql('param with description');

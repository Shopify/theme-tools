import { JSONSourceCode, LiquidSourceCode, Dependencies as ThemeCheckDependencies, UriString, Reference, Location, Range } from '@shopify/theme-check-common';
...
export type ThemeModule = LiquidModule | JsonModule | JavaScriptModule | CssModule | SvgModule | ImageModule;
export type FileSourceCode = LiquidSourceCode | JSONSourceCode | JsSourceCode | CssSourceCode | SvgSourceCode | ImageSourceCode;
...
export declare const enum JsonModuleKind {
    /** templates/*.json files */
    Template = "template",
    /** sections/*.json files */
    SectionGroup = "section-group"
}
export declare const enum LiquidModuleKind {
    /** layout/*.liquid files */
    Layout = "layout",
...
export declare const SUPPORTED_ASSET_IMAGE_EXTENSIONS: string[];

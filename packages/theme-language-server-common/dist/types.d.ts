import { AbstractFileSystem, Config, Dependencies as ThemeCheckDependencies, ObjectEntry } from '@shopify/theme-check-common';
...
export type Dependencies = WithOptional<RequiredDependencies, 'log' | 'getMetafieldDefinitions' | 'fetchMetafieldDefinitionsForURI'>;
...
export declare namespace ThemeGraphReferenceRequest {
    const method = "themeGraph/references";
    const type: rpc.RequestType<Params, Response, void>;
    interface Params {
        uri: string;
        offset?: number;
        includeIndirect?: boolean;
    }
    type Response = AugmentedReference[];
}
export declare namespace ThemeGraphDependenciesRequest {
    const method = "themeGraph/dependencies";
    const type: rpc.RequestType<Params, Response, void>;
    interface Params {
        uri: string;
        offset?: number;
...
export declare namespace ThemeGraphRootRequest {
    const method = "themeGraph/rootUri";
    const type: rpc.RequestType<Params, string, void>;
    interface Params {
        uri: string;
    }
    type Response = string;
}
export declare namespace ThemeGraphDeadCodeRequest {
    const method = "themeGraph/deadCode";
    const type: rpc.RequestType<Params, Response, void>;
    interface Params {
        uri: string;
    }
...
export declare namespace ThemeGraphDidUpdateNotification {
    const method = "themeGraph/onDidChangeTree";
    const type: rpc.NotificationType<Params>;
    interface Params {
        uri: string;
    }
}
export declare namespace SetObjectsNotification {
    const method = "shopify/setObjects";
    interface Params {
        uri: string;
        objects: ObjectEntry[];
    }

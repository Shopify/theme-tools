/** Represents a component in a Shopify theme */
type ThemeComponent = {
  /** Describes what the component is and how it's used in the theme */
  summary: string;
  /** Contains recommended best practices and tips for using the component */
  tip?: string;
};

/**
 * Defines the architecture and best practices for all components of a Shopify
 * theme, where the key is the theme component type (e.g. sections, blocks, etc)
 */
export const THEME_ARCHITECTURE: Record<string, ThemeComponent> = {
  /**
   * Sections
   * ---------------------------------------------------------------------------
   */

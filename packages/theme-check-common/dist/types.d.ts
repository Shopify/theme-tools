...
export declare const isValueNode: (node?: ASTNode) => node is ValueNode;
export declare const isLiteralNode: (node?: ASTNode) => node is LiteralNode;
...
export type MetafieldCategory = 'article' | 'blog' | 'collection' | 'company' | 'company_location' | 'location' | 'market' | 'order' | 'page' | 'product' | 'variant' | 'shop';
